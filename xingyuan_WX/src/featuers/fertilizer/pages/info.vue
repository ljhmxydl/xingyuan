  ...
  <view-box class="fertilizerInfo">
    ...
    <div style="padding-top:46px;">
      <group title="完善信息后会为您提供免费的测土服务">
        ...
        <x-input title="作物品种 " name="crop_type" type="text" v-model="crop_type" placeholder="请填写作物品种" ref="crop_type"
                 required></x-input>
        <x-input title="上季产量 " name="last_yeid" type="number" v-model="last_yeid" :is-type="isNum"
                 placeholder="上季产量应为整数" ref="last_yeid" required>
